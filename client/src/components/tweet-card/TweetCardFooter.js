function TweetCardFooter({ createdAt, retweetCount, likeCount }) {
    return (
        <div className="tweet-card--metrics">
            <p className="tweet-card--created-date">{createdAt}</p>
            ...
            <p className="tweet-card--retweet-count">{retweetCount}</p>
            ...
            <p className="tweet-card--like-count">{likeCount}</p>
        </div>
    );
};
